...
api.get('/obtener_cliente_public/:id',auth.auth, clienteController.obtener_cliente_public) 
api.put('/actualizar_perfil_cliente_public/:id',auth.auth, clienteController.actualizar_perfil_cliente_public) 
